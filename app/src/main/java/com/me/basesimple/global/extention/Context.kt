...
fun Fragment.getDrawableRes(@DrawableRes res: Int) = requireContext().getDrawableRes(res)

fun Context.getColorRes(@ColorRes id: Int) = ContextCompat.getColor(applicationContext, id)
fun Fragment.getColorRes(@ColorRes id: Int) = requireContext().getColorRes(id)

fun Context.getStringRes(@StringRes res: Int) = getString(res)
fun Fragment.getStringRes(@StringRes res: Int) = requireContext().getStringRes(res)
